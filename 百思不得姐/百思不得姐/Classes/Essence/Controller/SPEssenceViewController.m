...
@interface SPEssenceViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
-(void)setUpChildViewControllers{
    [self addChildViewController:[[SPAllViewController alloc] init]];
    [self addChildViewController:[[SPVideosViewController alloc] init]];
    [self addChildViewController:[[SPVoiceViewController alloc] init]];
    [self addChildViewController:[[SPPicturesViewController alloc] init]];
    [self addChildViewController:[[SPTextViewController alloc] init]];
}
#pragma mark- 添加内容控制器
...
-(void)setUpTitleButtons{
    ...
    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, buttonW * titleArray.count, buttonH)];
